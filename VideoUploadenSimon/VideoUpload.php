...
<html>
    ...
    <body>
        ...
        $avatar_path = $DBConnect->real_escape_string('videos/' . $_FILES['video']['name']);

        $SQLstring = "INSERT INTO videos VALUES (?)";

        if ($stmt = mysqli_prepare($DBConnect, $SQLstring)) {
            mysqli_stmt_bind_param($stmt, "s", $video_path);
            ...
            if ($QueryResult === FALSE) {
                ...
                echo "<h1>Thank you for reporing!</h1>";
            }
