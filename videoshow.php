                                    ...
                                    while (mysqli_stmt_fetch($stmt)) {
                                      echo" <div id='iframeBox'>
                                        ...
                                        <source src='".$Path."' type=video/wav>
                                            ...
                                            <p>".$Title."</p></div>
                                            <div class='display'><form action='videoshow.php' method='POST'>
                                                <input type='checkbox' name='fav' value='$VideoID' checked>
